package com.example.movieproappusingpaginglibrary.adapters;
...
import com.example.movieproappusingpaginglibrary.databinding.LoadItemStateBinding;
    ...
    public static class LoadStateViewHolder extends RecyclerView.ViewHolder{
        ...
        public LoadStateViewHolder(@NonNull ViewGroup parent,
            ...
            super(LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.load_item_state, parent, false));


            LoadItemStateBinding binding = LoadItemStateBinding.bind(itemView);
